...
//                     </div>
//                     <div style={{ background: 'rgba(255,255,255,0.03)', padding: '20px', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.06)', textAlign: 'center' }}>
//                         <div style={{ fontSize: '28px', fontWeight: '900', color: '#10b981' }}>0</div>
...
//                     <button onClick={() => toast.info("Your order history will appear here soon!")} style={{ width: '100%', padding: '16px', background: 'rgba(255,255,255,0.08)', color: '#fff', border: 'none', borderRadius: '16px', fontSize: '14px', fontWeight: '700', cursor: 'pointer', transition: 'background 0.2s' }} onMouseOver={(e) => e.target.style.background = 'rgba(255,255,255,0.12)'} onMouseOut={(e) => e.target.style.background = 'rgba(255,255,255,0.08)'}>
//                         📦 View Order History
//                     </button>
//                     <button onClick={handleLogout} style={{ width: '100%', padding: '16px', background: 'rgba(239, 68, 68, 0.1)', color: '#ef4444', border: '1px solid rgba(239, 68, 68, 0.2)', borderRadius: '16px', fontSize: '14px', fontWeight: '800', cursor: 'pointer', transition: 'all 0.2s', textTransform: 'uppercase', letterSpacing: '1px' }} onMouseOver={(e) => { e.target.style.background = 'rgba(239, 68, 68, 0.2)' }} onMouseOut={(e) => { e.target.style.background = 'rgba(239, 68, 68, 0.1)' }}>
//                         Log Out
//                     </button>
//                 </div>
...
//     // Pull down global arrays
//     const { savedReels, cartItems, setCartItems, activeOrders } = useContext(AppContext);
...
//                                         <div style={{ width: '60px', height: '60px', background: '#000', borderRadius: '12px', overflow: 'hidden' }}>
//                                             <video src={item.video} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
//                                         </div>
//                                         <div style={{ flex: 1 }}>
//                                             <h4 style={{ margin: '0 0 4px 0', fontSize: '15px', color: '#fff' }}>{item.name || item.title || "Special Dish"}</h4>
//                                             <p style={{ margin: 0, fontSize: '12px', color: '#888', display: '-webkit-box', WebkitLineClamp: 1, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>{item.description}</p>
//                                         </div>
//                                         <button 
//                                             onClick={() => setCartItems(prev => prev.filter((_, i) => i !== index))}
//                                             style={{ background: 'rgba(220, 38, 38, 0.15)', color: '#ef4444', border: 'none', padding: '8px', borderRadius: '50%', cursor: 'pointer' }}
//                                         >
//                                             🗑️
//                                         </button>
//                                     </div>
