...
const FoodPartnerRegister = () => {
  ...
  const handleSubmit = async (e) => { 
    ...
    try {
      const response = await axios.post("https://food-app-backend-rnwb.onrender.com/api/auth/food-partner/register", {
        name: businessName,
        contactName,
        phone,
        email,
      ...
      toast.success("Partner account created successfully! Please log in.");
